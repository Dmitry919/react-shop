...
import { addItems, removeItem, minusItem, TCartItems } from '../redux/Slices/cartSlice'
...
const CartItem: React.FC<CartItemProps> = ({ id, name, type, price, count, size, imageUrl }) => {

    const dispatch = useDispatch()

    const onClickPlus = () => {
        dispatch(addItems({id} as TCartItems))
    }
